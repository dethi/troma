...
namespace Troma
{
    public class MenuEntry
    {
        ...
        private readonly Color notSelectedColor2;
        private readonly Color selectedColor2;
        ...
        public MenuEntry(string text, float fontSize, float rot, bool isPulsate)
        {
            ...
            notSelectedColor2 = new Color(150, 145, 140);
        ...
        public virtual void Draw(GameTime gameTime, MenuScreen screen, bool isSelected)
        {
            ...
            Color color2 = (isSelected) ? selectedColor2 : notSelectedColor2;
            color *= screen.TransitionAlpha;
            ...
            float scale2 = ((FontSize + selectionFade * 0.52f +
                selectionFade * pulsate * 0.1f) *
                GameServices.GraphicsDevice.Viewport.Width) / 1980;

            Vector2 origin = new Vector2(0, screen.Font.LineSpacing / 2);

            GameServices.SpriteBatch.DrawString(screen.Font, Text, Position, color2 * 0.2f, _rotation,
                origin, scale2, SpriteEffects.None, 0);
